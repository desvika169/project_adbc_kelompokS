...
with c1:
    st.markdown(f'<div class="metric-card"><div class="metric-value">{val_kecelakaan}</div><div class="metric-label">Total Kecelakaan</div></div>', unsafe_allow_html=True)
with c2:
    st.markdown(f'<div class="metric-card"><div class="metric-value">{val_state}</div><div class="metric-label">Jumlah State</div></div>', unsafe_allow_html=True)
with c3:
    st.markdown(f'<div class="metric-card"><div class="metric-value">{val_fatalitas}</div><div class="metric-label">Total Fatalitas</div></div>', unsafe_allow_html=True)
with c4:
    st.markdown(f'<div class="metric-card"><div class="metric-value">{val_drunk}</div><div class="metric-label">Total Drunk Driver</div></div>', unsafe_allow_html=True)
